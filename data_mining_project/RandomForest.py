...
# creates regressor object 
regressor = RandomForestRegressor(n_estimators = 100, random_state = 0) 

# fits the regressor with x and y data 
regressor.fit(X_train, y_train) 
forest_pred_train = regressor.predict(X_train) # tests the output by changing values 
...
forest_pred = regressor.predict(X_test) # tests the output by changing values 
